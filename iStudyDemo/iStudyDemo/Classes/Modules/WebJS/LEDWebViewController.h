...
@property (nonatomic, strong) LEDWebViewControllerJavascriptBridgeHelper *webViewControllerJavascriptBridgeHelper;
@property (nonatomic, assign) BOOL enableWebViewJavascriptBridge;
