...
@interface WD2ViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
...
@implementation WD2ViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar insertSubview:self.backView atIndex:0];
}
