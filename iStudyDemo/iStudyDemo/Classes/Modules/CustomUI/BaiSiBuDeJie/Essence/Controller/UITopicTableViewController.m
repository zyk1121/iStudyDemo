...
@interface UITopicTableViewController ()<BSTopicCellDelegate>
...
@implementation UITopicTableViewController
...
- (void)refreshData
{
    ...
    [params setObject:[NSString stringWithFormat:@"%zd", [self type]] forKey:@"type"];
