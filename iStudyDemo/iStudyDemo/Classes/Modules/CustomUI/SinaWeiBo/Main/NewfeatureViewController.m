...
#define LDRGBCOLOR(r,g,b) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:1]
...
- (void)viewDidLoad {
    ...
    pageControl.currentPageIndicatorTintColor = LDRGBCOLOR(253, 98, 42);
    pageControl.pageIndicatorTintColor = LDRGBCOLOR(189, 189, 189);
